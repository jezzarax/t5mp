...
def _get_partition_rules():
    return [
        ...
        ((r"shared", "embedding"), P("mp", None)),
        ((r"relative_attention_bias", "embedding"), P("mp", None)),
        # self-attention
        ...
        # FFN
        ((r"DenseReluDense", "(wi|wo|wi_1|wi_0)", "kernel"), P(None, "mp")),
        # ((r"fc2", "kernel"), P("mp", None)),
        # layer norms
        # ((r"layer_norm", "(bias|scale|kernel)"), None),
        ((r"layer_norm", "(bias|scale|kernel|weight)"), None),
        # ((r"self_attn_layer_norm", "(bias|scale)"), None),
        # ((r"encoder_attn_layer_norm", "(bias|scale)"), None),
        ((r"final_layer_norm", "(bias|scale|kernel|weight)"), None),
